...
- Queue extension in review: خ-162 «روحك تموت» approved 2026-09-07 (review `wr/تطوير/نماذج/خ-162-روحك-تموت.md`; approval covered keeping «إنجاب ابنًا غير شرعي» + «اللهم احرق أوروبا» + new series «يوميات المهاجر») → queue, publishes 2026-09-12 ✓. **خ-179 «خذ هويتك وارجع إلى بيتك» وخ-196 «تجربة اللجوء في فنلندا» عُرضا على الكاتب بصفحتي متصفح 2026-09-08** (`wr/تطوير/عروض-مراجعة/خ-179.html` + `خ-196.html`؛ النموذجان في `wr/تطوير/نماذج/`) — بانتظار الاعتماد. عند الاعتماد: خ-179 → `queue/kh-179-khudh-huwwiyyatak.md` (2026-09-14، سلسلة «ما قبل الرحيل»)، خ-196 → `queue/kh-196-lujo-finlanda.md` (2026-09-15، السلسلة نقطة قرار معلقة). ثم التاليان: **خ-152 «برهان»** (النوفيلا، تحتاج دفعات عمل طويلة) → **خ-180 «سلوى»** (★★، بناء حذر). خ-140 «مريم» في خطة الباب الأول لكنه ⚠️ حسّاس (§5.4: لا يُنشر إلا بموافقة صريحة منفصلة). Review = author session per text (درس خ-031: documented final approval) **presented as a browser page (`wr/تطوير/عروض-مراجعة/`, author's rule 2026-09-07 — never as terminal text)**, then move to `queue/` with a date.
