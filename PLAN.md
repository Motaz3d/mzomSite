...
- Queue extended to 09-17: **خ-182 «قصة الحب من آيندهوفن» approved by the author 2026-09-08** (بكلمة «معتمد» بعد عرض `wr/تطوير/عروض-مراجعة/خ-182.html`) — حسم: حذف العناوين الآلية، الخاتمة المفتوحة المشتعلة بلا تتمة، سلسلة «سلوى والحب» → `queue/kh-182-hobb-eindhoven.md` (2026-09-17). وقبلها بنفس اليوم: خ-179 (09-14)، خ-196 (09-15)، خ-180 (09-16). خ-162 approved 2026-09-07 → 09-12 ✓. **خ-152 «برهان» ⏸️ متوقف: جسد النوفيلا غير مؤرشف** (جرد في `wr/تطوير/نماذج/خ-152-برهان.md` — طُلب النص الكامل من الكاتب). **في المراجعة الآن: خ-211 «المهاجر — الشخصية المركبة»** عُرض بصفحة متصفح 2026-09-08 (`wr/تطوير/عروض-مراجعة/خ-211.html`) — بانتظار الاعتماد، وعنده → `queue/kh-211-al-muhajir.md` (2026-09-18، «يوميات المهاجر»). بعده تنفد مرشحو ★★★ — التالون بجرد جديد (خ-206، خ-145ب، خ-191، خ-193). خ-140 «مريم» ⚠️ حسّاس (§5.4: لا يُنشر إلا بموافقة صريحة منفصلة). Review = author session per text (درس خ-031) **presented as a browser page (`wr/تطوير/عروض-مراجعة/`)**, then move to `queue/` with a date.
