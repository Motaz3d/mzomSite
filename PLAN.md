...
- Queue extended to 09-15: **خ-179 «خذ هويتك وارجع إلى بيتك» وخ-196 «تجربة اللجوء في فنلندا» approved by the author 2026-09-08** (بكلمة «معتمد» بعد عرض صفحتي المتصفح `wr/تطوير/عروض-مراجعة/خ-179.html` + `خ-196.html`؛ النموذجان الموثقان في `wr/تطوير/نماذج/`). اعتماد خ-179 حسم: القراءات الأربع للعبارات المتعثرة، إبقاء خاتمة «سلوى» خطافًا مفتوحًا، سلسلة «ما قبل الرحيل» → `queue/kh-179-khudh-huwwiyyatak.md` (2026-09-14). اعتماد خ-196 حسم: إبقاء فقرة منطق المعسكر، قراءة «جسدها»، وسلسلة «يوميات المهاجر» (ثُبتت عند الاعتماد — كانت بلا خيار معروض) → `queue/kh-196-lujo-finlanda.md` (2026-09-15). خ-162 «روحك تموت» approved 2026-09-07 → publishes 2026-09-12 ✓. ثم التاليان: **خ-180 «سلوى» عُرضت على الكاتب بصفحة متصفح 2026-09-08** (`wr/تطوير/عروض-مراجعة/خ-180.html`؛ النموذج في `wr/تطوير/نماذج/خ-180-سلوى.md`) — بانتظار الاعتماد، وعنده → `queue/kh-180-salwa.md` (2026-09-16، سلسلة جديدة «سلوى والحب») → ثم **خ-152 «برهان»** (النوفيلا، تحتاج دفعات عمل طويلة). خ-140 «مريم» في خطة الباب الأول لكنه ⚠️ حسّاس (§5.4: لا يُنشر إلا بموافقة صريحة منفصلة). Review = author session per text (درس خ-031: documented final approval) **presented as a browser page (`wr/تطوير/عروض-مراجعة/`, author's rule 2026-09-07 — never as terminal text)**, then move to `queue/` with a date.
