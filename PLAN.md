...
- Queue extended to 09-19: **خ-206 «سلوى — القصيدة» approved by the author 2026-09-08** (بكلمة «معتمدة» بعد عرض `wr/تطوير/عروض-مراجعة/خ-206.html`) — أول قصيدة؛ حسم: العنوان «سلوى — القصيدة»، إبقاء «يبرم» و«النية»، تسمية «خطيبتي السابقة» → `queue/kh-206-salwa-qasida.md` (2026-09-19، «سلوى والحب»). **build.py صار يدعم الشعر** (السطر المنفرد ← `<br>`؛ صفر فروق). وقبلها بنفس اليوم: خ-179 (09-14)، خ-196 (09-15)، خ-180 (09-16)، خ-182 (09-17)، خ-211 (09-18). خ-162 approved 2026-09-07 → 09-12 ✓. **خ-152 «برهان» ⏸️ متوقف: جسد النوفيلا غير مؤرشف** (جرد في `wr/تطوير/نماذج/خ-152-برهان.md` — طُلب النص الكامل من الكاتب). التالون للمراجعة: **خ-145ب «إلى سارة» عُرض على الكاتب بصفحة متصفح 2026-09-08** (`wr/تطوير/عروض-مراجعة/خ-145ب.html`) — بانتظار الاعتماد، وعنده → `queue/kh-145b-ila-sara.md` (2026-09-20، «سلوى والحب») ← ثم خ-191 «دعاء» ← خ-193 «أنا مخلوق من ندم» (فحص خام قبل العرض). خ-140 «مريم» ⚠️ حسّاس (§5.4: لا يُنشر إلا بموافقة صريحة منفصلة). Review = author session per text (درس خ-031) **presented as a browser page (`wr/تطوير/عروض-مراجعة/`)**, then move to `queue/` with a date.
