...
- Queue extended to 09-16: **خ-180 «سلوى» approved by the author 2026-09-08** (بكلمة «معتمد» بعد عرض `wr/تطوير/عروض-مراجعة/خ-180.html`؛ النموذج `wr/تطوير/نماذج/خ-180-سلوى.md`) — حسم الاعتماد: إبقاء الفاتحة المقترحة من خام الكاتب، قراءة «أشلائها»، إبقاء «قتلت روحي إلى روحي»، وفتح **سلسلة جديدة «سلوى والحب»** → `queue/kh-180-salwa.md` (2026-09-16). وقبله بيوم: خ-179 «خذ هويتك» (09-14، «ما قبل الرحيل») وخ-196 «تجربة اللجوء في فنلندا» (09-15، «يوميات المهاجر») معتمدان 2026-09-08 أيضًا (النموذجان في `wr/تطوير/نماذج/`). خ-162 «روحك تموت» approved 2026-09-07 → publishes 2026-09-12 ✓. **خ-152 «برهان» ⏸️ متوقف: جسد النوفيلا غير مؤرشف** (جرد 2026-09-08 في `wr/تطوير/نماذج/خ-152-برهان.md` — الأرشيف يحوي الافتتاحية المشذّبة + «غدر الضعيف» فقط؛ لبنان/بغداد/الدفن/أم كلثوم/خاتمة خ-153 التي تصفها الخريطة غير موجودة — طُلب النص الكامل من الكاتب). وبدلًا منه في المراجعة الآن: **خ-182 «قصة الحب من آيندهوفن» عُرضت على الكاتب بصفحة متصفح 2026-09-08** (`wr/تطوير/عروض-مراجعة/خ-182.html`) — بانتظار الاعتماد، وعنده → `queue/kh-182-hobb-eindhoven.md` (2026-09-17، سلسلة «سلوى والحب»). ثم **خ-211 «المهاجر — الشخصية المركبة»** (★★★، يحتاج بناءً؛ 09-18). خ-140 «مريم» في خطة الباب الأول لكنه ⚠️ حسّاس (§5.4: لا يُنشر إلا بموافقة صريحة منفصلة). Review = author session per text (درس خ-031: documented final approval) **presented as a browser page (`wr/تطوير/عروض-مراجعة/`, author's rule 2026-09-07 — never as terminal text)**, then move to `queue/` with a date.
