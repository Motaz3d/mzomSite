...
- **Content source:** النصوص من ورشة الكتابة `/Users/digital-inclusion/Documents/work/wr` — يُنشر فقط ما يوافق عليه الكاتب بموافقة نهائية موثقة (درس خ-031). **المنشور:** خ-102 «مشاكسة الموريتانيّة» (pieces/muritaniyya.html — أول نصوص الكتاب، 2026-09-06).
