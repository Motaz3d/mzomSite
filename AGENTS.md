...
- **Content source:** النصوص من ورشة الكتابة `/Users/digital-inclusion/Documents/work/wr` — يُنشر فقط ما يوافق عليه الكاتب بموافقة نهائية موثقة (درس خ-031: نُشرت ثم حذفها الكاتب 2026-09-05). حاليًا لا نصوص منشورة — أول نص ينتظر اعتماد «المخدوع» (خ-096).
