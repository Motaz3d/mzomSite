...
- **Content source:** النصوص من ورشة الكتابة `/Users/digital-inclusion/Documents/work/wr` — يُنشر فقط ما يوافق عليه الكاتب بموافقة نهائية موثقة (درس خ-031). **المنشور:** خ-102 «مشاكسة الموريتانيّة» + خ-103 «لي صديق» (2026-09-06). المخزون لإطلاق اليومي: **2/7**. ملاحظة تقنية: ترتيب النصوص يُحسم برقم خ عند تساوي التاريخ.
