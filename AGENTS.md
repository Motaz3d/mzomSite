...
- **Structure:**
  ...
  - **النشر على Pages:** عبر GitHub Actions (`.github/workflows/deploy.yml` — build_type=workflow منذ 2026-09-08؛ أُصلح 2026-09-09 بعد أن توقفت الدفعات يومًا كاملًا). كل push إلى main يشغّل deploy تلقائيًا.
